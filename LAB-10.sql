...
SELECT LOWER('Om'), UPPER('Om')
--3. Display first three characters of your name.
SELECT SUBSTRING('OMPATEL',1,3)
--4. Display 3rd to 10th character of your name.
SELECT SUBSTRING('OMPANCHOTIYA',3,7)
--5. Write a query to convert ‘abc123efg’ to ‘abcXYZefg’ & ‘abcabcabc’ to ‘ab5ab5ab5’ using REPLACE.
SELECT REPLACE('abc123efg','123','XYZ'), REPLACE('ab5ab5ab5','C','5')
...
SELECT SPACE(10) + 'OMPATEL'
--14. Combine two strings using + sign as well as CONCAT ().
SELECT --15. Find reverse of “Darshan”.
...
SELECT FIRSTNAME, REPLACE(FIRSTNAME, 'A', '@')
FROM EMPLOYEE;
...
SELECT FIRSTNAME, REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(FIRSTNAME), 'A', '*'),'E', '*'),'I', '*'),'O', '*'),'U', '*')
FROM EMPLOYEE;
